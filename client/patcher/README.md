...
Na ETAPA 2O-D1-B16, foram preparados o **manifesto de apresentação** e o **comprovante de entrega em branco** ([`beam-audit/first-build-human-presentation-manifest.example.json`](beam-audit/first-build-human-presentation-manifest.example.json), [`beam-audit/first-build-human-presentation-receipt.example.json`](beam-audit/first-build-human-presentation-receipt.example.json)), documentados em [`docs/27-apresentacao-controlada-pacote-decisao-beam.md`](../../docs/27-apresentacao-controlada-pacote-decisao-beam.md). O manifesto (estado `NOT_PRESENTED`) registra o conteúdo, os canais permitidos, os critérios de autoridade e os procedimentos de integridade/entrega/devolução/aceitação, referenciando os seis artefatos por hash (ancorados ao merge do PR #40); o comprovante é um formulário em branco. Nenhum dos dois **apresenta**, **seleciona canal**, **identifica decisor**, **confirma recebimento**, **registra decisão** ou **concede autorização**; a entrega real será registrada na ETAPA 2O-D1-B17, com entrada humana explícita. **Apresentação não é decisão; decisão não é autorização; decisão não executa o build.**
